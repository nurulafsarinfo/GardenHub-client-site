    ...
    return (
        <div className="p-6">
            ...
            <div className='mb-8'>
                ...
                <div className='flex flex-col items-center md:w-[350px] w-full my-3 p-8 rounded-2xl bg-gradient-to-br from-green-500 to-yellow-300'>
                    <div >
            ...
            <div className='md:flex gap-4 space-y-5 '>
                ...
                {/* total shared tips  */}
                <div className='flex items-center gap-4 bg-gradient-to-b from-green-400 to-yellow-300 w-full md:w-[300px] p-4 rounded-2xl shadow-lg'>
                    <h1 className='text-white text-xl'>My Total Shared Tips</h1>
                    <p className='text-5xl text-green-700 font-bold mt-1'>{totalaMyTips}</p>
                </div>

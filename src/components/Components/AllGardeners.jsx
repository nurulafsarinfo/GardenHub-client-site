                    ...
                    >
                        ...
                        <div className="flex gap-4 p-4 bg-indigo-100 dark:bg-indigo-300">
                            ...
                            <div className="flex-1 ">
                                <div className="flex justify-between items-start">
                                    <p className="text-lg font-semibold text-gray-800 dark:text-slate-800">{gardener.name}</p>
                                    <span className="px-2 py-1 text-xs bg-blue-500 text-white rounded">
                                        {gardener.gender}
                                    </span>
                                </div>
                                <div className="flex items-center text-sm text-gray-600 dark:text-slate-500 mt-1">
                                    <CiLocationOn className="mr-1" />
                                    {gardener.location}
                                </div>

                                <p className="text-sm italic mt-2 text-gray-700 dark:text-slate-500">
                                    <span className="font-medium">Specialty:</span> {gardener.specialty}
                                </p>

                                <div className="flex gap-4 mt-2 text-sm text-gray-700 dark:text-slate-500">
                        ...
                        <div className="bg-gray-100 rounded-t-2xl dark:bg-gray-700 p-4">
                            ...
                            <div className="flex items-center gap-2 text-gray-800 dark:text-white">
                                <p className="font-medium italic ">Total Shared Tips:</p>

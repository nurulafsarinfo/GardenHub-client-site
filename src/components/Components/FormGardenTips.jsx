        ...
        <div>
            <div className='shadow-2xl border-3 border-gray-200 rounded-2xl md:w-[500px] w-[400px] mx-auto my-10  p-10 bg-green-100 '>
                <form onSubmit={handleTipsForm}>
                    ...
                    <br />
                    <input type="text" name="name" placeholder='(e.g., “How I Grow Tomatoes Indoors”)
                    ...
                    <div className='flex gap-3'>
                        <div className='w-full'>
                            ...
                            <br />
                            <input type="text" name="name" value={user.displayName} className='border-2 bg-slate-100 text-amber-900 md:text-lg text-sm p-2 rounded-2xl my-2 w-full' required />
                        </div>

                        <div className='w-full'>
                            <label className='label md:text-2xl text-xl text-amber-900'>Email</label>
                            <br />
                            <input type="email" name="email" value={user.email} className='border-2 bg-slate-100 text-amber-900 md:text-lg text-sm p-2 rounded-2xl my-2 w-full' required />
                        </div>
                    </div>
